...
molecules simulation, you would also need the list of bonds.

To illustrate the idea, let's write checkpointing for the Lennard-Jones system.
...
\begin{lstlisting}
%! codeblock: 
    int checkpointEverynSteps = simParams.checkpointEverynSteps;
    if(checkpointEverynSteps > 0
       and step % checkpointEverynSteps == 1) {
      auto position
        = particles->getPos(access::location::cpu,
                            access::mode::read);
      auto velocity
      ...
      std::string checkpointFile
        = "checkpoint."
          + std::to_string(step/checkpointEverynSteps)
          + ".dat";
