...
differential equation, the most popular of which is the popular Euler-Maruyama 
scheme. Include them with:
\begin{lstlisting}
...
Activating Brownian dynamics integrators the pattern that we have become 
...
\section{Diffusion, structure and pressure}
