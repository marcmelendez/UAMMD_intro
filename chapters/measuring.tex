...
You might feel let down by the example above. I chose the Andersen thermostat as 
an example precisely because I could sidestep the problem of dealing with all 
the interactions. Having familiarised ourselves with the inner workings of an 
...
Other measurements: RDF, mean square displacements, time correlation functions.
