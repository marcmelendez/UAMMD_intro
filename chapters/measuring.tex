...
more realistically than Lennard-Jones potentials. Apart from setting the 
parameters in the potential, we will shift the potential upwards to avoid a 
discontinuity at the cut-off distance \texttt{rc}.
\begin{lstlisting}
...
%% Careful! Clean virial and run interactor->compute().
