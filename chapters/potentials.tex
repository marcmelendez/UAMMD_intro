...
will dissolve as soon as the particles separate further than the cut-off radius.
...
na\"ive implementation of this condition will lead to inconsistencies because 
two nearby particles might to bond to a third. We therefore need a new algorithm 
to deal with bond creation.
