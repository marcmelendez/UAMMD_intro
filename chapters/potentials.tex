...
have a simulation box defined (as explained in section \ref{simulation_box}).
\begin{lstlisting}
  {
    ...
    Params.readfile = "data.angularForces";
    auto angularForces
      = make_shared<angularPorentials>(particles, sys, 
                                       angularParameters,
                                       AngularBondedForces_ns::AngularBond(box));
