...
%! codefile: superLennard-Jones.cu
# include "uammd.cuh"
# include "utils/InputFile.cuh"
# include "utils/InitialConditions.cuh"
# include "Interactor/Potential/Potential.cuh"
...
int main(int argc, char *argv[]){
...

  {
    InputFile parameterFile("data.main", sys);
    parameterFile.getOption("numberOfParticles",
      InputFile::Required)>>simParams.numberOfParticles;
    parameterFile.getOption("boxSize",
      InputFile::Required)>>simParams.L;
    parameterFile.getOption("timeStep",
      InputFile::Required)>>simParams.dt;
    parameterFile.getOption("particleEnergy",
      InputFile::Required)>>simParams.particleEnergy;
    parameterFile.getOption("epsilon",
      InputFile::Required)>>simParams.epsilon;
    parameterFile.getOption("sigma",
      InputFile::Required)>>simParams.sigma;
    parameterFile.getOption("cutOff",
      InputFile::Required)>>simParams.cutOff;
    parameterFile.getOption("outputFile",
      InputFile::Required)>>simParams.outputFile;
    parameterFile.getOption("numberOfSteps",
      InputFile::Required)>>simParams.numberOfSteps;
    parameterFile.getOption("printEverynSteps",
      InputFile::Required)>>simParams.printEverynSteps;
  }
